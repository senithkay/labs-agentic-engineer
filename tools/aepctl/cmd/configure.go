...
in the wso2-aep namespace. Can be run before 'aep platform install' to
pre-seed configuration — install reads the ConfigMap when present and
falls back to defaults for any missing keys.

Use this to set or update AEP configuration without re-running aep platform install.
