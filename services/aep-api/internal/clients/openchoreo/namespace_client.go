...
type NamespaceClient interface {
	ListNamespaces(ctx context.Context) ([]apigen.OrganizationView, error)
	GetNamespace(ctx context.Context, name string) (*apigen.OrganizationView, error)
}
...
func (c *namespaceClient) ListNamespaces(ctx context.Context) ([]apigen.OrganizationView, error) {
	...
	items := make([]apigen.OrganizationView, len(resp.JSON200.Items))
...
func (c *namespaceClient) GetNamespace(ctx context.Context, name string) (*apigen.OrganizationView, error) {
...
func namespaceToView(n gen.Namespace) apigen.OrganizationView {
	var phase string
	if n.Status != nil && n.Status.Phase != nil {
		phase = string(*n.Status.Phase)
	}
	return apigen.OrganizationView{
